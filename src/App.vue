<template>
  <div id="app">
      ...
      <div class="overflow-hidden w-full h-full relative">
        <div class="flex h-full flex-1 flex-col md:pl-[260px]">
          ...
          <main class="relative h-full w-full transition-width flex flex-col overflow-hidden items-stretch flex-1">
            ...
            <!-- 资源渠道选择器 -->
            <ToggleSource @sourceChange="sourceChange"/>
            <!-- 回到底部 -->
            <div v-show="isShowGoBottom" @click="handleScrollBottom" style="height: 34px;width: 34px;position: fixed; top:25px;right: 20px;">
              <a-button :class=" theme === 'light'?'lightButtonBackground':'darkButtonBackground'" style="max-height: 34px; min-width: 34px; max-width: 34px; padding: 0px;display: flex; justify-content: center; align-items: center;">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none"><g clip-path="url(#arrow_drop_down_svg__a)"><path fill="currentColor" d="m4.33 7.239 2.886 2.885a1.11 1.11 0 0 0 1.57 0l2.886-2.885c.702-.702.201-1.905-.79-1.905H5.11c-.991 0-1.482 1.203-.78 1.905Z"></path></g><defs><clipPath id="arrow_drop_down_svg__a"><path fill="#fff" d="M0 0h16v16H0z"></path></clipPath></defs></svg>
              </a-button>
            </div> 
                ...
                <div ref="chatContainer" class="react-scroll-to-bottom--css-krija-1n7m0yu">
                  <div class="flex flex-col items-center text-sm dark:bg-gray-800">
                    ...
                    <template v-for="conv, idx in conversation">
                      <!-- human -->
                      <div v-if="idx == 0" style="height: 80px;"></div>

                      <div v-if="conv.speaker == 'human'" :style=" theme === 'light'?'border-bottom: #d2d4de 1px solid;':'border-bottom: #2c2d3c 1px solid;'"
                        ...
                        <div
                          ...
                          <div
                              class="relative flex w-[calc(100%-50px)] flex-col gap-1 md:gap-3 lg:w-[calc(100%-50px)]">
                            ...
                            <div>
                              ...
                              <div class="flex">
                                <div>9 minutes ago</div>
                                  <div class="text-gray-400 flex self-end lg:self-center justify-center mt-2 gap-3 md:gap-4 lg:gap-1 lg:absolute lg:right-0 lg:mt-0 lg:pl-2 visible">
                                    <a-tooltip placement="top" title="Edit" :color="tooltipColor">
                                      <button class="p-1 rounded-md hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-200 disabled:dark:hover:text-gray-400">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" aria-label="Edit chat" class="h-5 w-5 cursor-pointer text-th-primary-light hover:text-th-primary-dark"><path fill="currentColor" fill-rule="evenodd" d="M15.81 2.918a1.313 1.313 0 0 0-.356.244c-.104.121-.074.16.852 1.121.868.902.968.987 1.065.904.32-.276.434-1.095.219-1.586-.292-.67-1.133-.992-1.78-.683Zm-10.877.855c-.584.143-1.11.577-1.42 1.171l-.213.41v10.228l.146.305c.233.488.594.865 1.054 1.1l.416.213h9.711l.294-.142c.37-.18.818-.606 1.027-.977.314-.557.326-.737.327-4.641l.001-3.624-.715.742-.716.742v2.947c0 2.768-.008 2.958-.117 3.146-.252.43-.085.415-4.951.415-4.76 0-4.63.01-4.952-.353l-.156-.175V5.655l.156-.175c.316-.356.279-.353 3.935-.353h3.38l.682-.712.683-.712-4.17.006c-2.292.004-4.273.033-4.402.064Zm6.85 3.215-3.031 3.156-.286 1.192c-.378 1.574-.457 1.495 1.075 1.086l1.165-.312L13.74 8.96l3.034-3.151-.948-.988c-.522-.543-.963-.988-.98-.988-.018 0-1.396 1.42-3.063 3.156Z" clip-rule="evenodd"></path></svg>
                                      </button>
                                    </a-tooltip>
                                    <a-tooltip placement="top" title="Copy" :color="tooltipColor">
                                      <button @click="copyChatDialogue($event, 'oneself')" class="p-1 rounded-md hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-200 disabled:dark:hover:text-gray-400">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="none" aria-label="Copy" viewBox="0 0 12 12" class="cursor-pointer text-th-primary-light hover:text-th-primary-dark"><g clip-path="url(#copy_svg__a)"><path fill="currentColor" d="M7.41 1h-5c-.5 0-.91.41-.91.91v5.908a.456.456 0 0 0 .91 0V2.364c0-.25.204-.455.454-.455h4.545c.25 0 .455-.204.455-.454A.456.456 0 0 0 7.409 1Zm1.817 1.818h-5c-.5 0-.909.41-.909.91v6.363c0 .5.41.909.91.909h5c.5 0 .908-.41.908-.91V3.728c0-.5-.409-.909-.909-.909Zm-.454 7.273H4.682a.456.456 0 0 1-.455-.455V4.182c0-.25.205-.455.455-.455h4.09c.25 0 .455.205.455.455v5.454c0 .25-.204.455-.454.455Z"></path></g><defs><clipPath id="copy_svg__a"><path fill="#fff" d="M0 0h12v12H0z"></path></clipPath></defs></svg>
                                      </button>
                                    </a-tooltip>
                                    <a-tooltip placement="top" title="Delete" :color="tooltipColor">
                                      <button class="p-1 rounded-md hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-200 disabled:dark:hover:text-gray-400">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" aria-label="Delete" viewBox="0 0 20 20" class="h-5 w-5 cursor-pointer text-th-primary-light hover:text-th-primary-dark"><g clip-path="url(#delete_svg__a)"><path fill="currentColor" d="M13.334 7.5v8.333H6.667V7.5h6.667Zm-1.25-5H7.917l-.833.833H4.167V5h11.667V3.333h-2.917l-.833-.833ZM15 5.833H5v10c0 .917.75 1.667 1.667 1.667h6.667c.916 0 1.666-.75 1.666-1.667v-10Z"></path></g><defs><clipPath id="delete_svg__a"><path fill="#fff" d="M0 0h20v20H0z"></path></clipPath></defs></svg>
                                      </button>
                                    </a-tooltip>
                                  </div>
                              </div>
                      ...
                      <div v-if="conv.speaker == 'ai'" 
                          :style=" theme === 'light'?'border-bottom: #d2d4de 1px solid;':'border-bottom: #2c2d3c 1px solid;'"
                        ...
                        <div
                          ...
                          <div class="w-[30px] flex flex-col relative items-end">
                            <div
                              ...
                              <svg width="41" height="41" viewBox="0 0 41 41" fill="none"
                                   src="../assets/imgs/ai.png" stroke-width="1.5" class="h-6 w-6">
                                <path
                          ...
                          <div
                            ...
                            <div class="flex h-6">
                                <div class="text-gray-400 flex lg:self-center justify-center mt-2 gap-3 md:gap-4 lg:gap-1 lg:absolute lg:translate-x-0 lg:left-0 lg:mt-0 visible">
                                  <a-tooltip placement="top" title="Good response" :color="tooltipColor">
                                      <button class="p-1 rounded-md hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-200 disabled:dark:hover:text-gray-400">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" fill="none" aria-label="Good response" class="block cursor-pointer text-th-primary-light hover:text-th-primary-dark"><path fill="currentColor" d="M8.318 17.2h6.546c.603 0 1.12-.36 1.338-.878l2.196-5.076c.066-.166.102-.339.102-.526V9.28c0-.792-.654-1.44-1.454-1.44h-4.59l.691-3.29.022-.23c0-.296-.123-.57-.32-.764l-.77-.756-4.794 4.745c-.261.26-.421.619-.421 1.015v7.2c0 .792.654 1.44 1.454 1.44Zm0-8.64 3.157-3.125L10.5 9.28h6.546v1.44l-2.182 5.04H8.318v-7.2Zm-5.818 0h2.91v8.64H2.5V8.56Z"></path></svg>                                      </button>
                                    </a-tooltip>
                                    <a-tooltip placement="top" title="Bad response" :color="tooltipColor">
                                      <button class="p-1 rounded-md hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-200 disabled:dark:hover:text-gray-400">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" fill="none" aria-label="Bad response" class="block cursor-pointer text-th-primary-light hover:text-th-primary-dark"><path fill="currentColor" d="M12.682 2.8H6.136c-.603 0-1.12.36-1.338.878L2.602 8.754a1.41 1.41 0 0 0-.102.526v1.44c0 .792.655 1.44 1.455 1.44h4.589l-.691 3.29-.022.23c0 .296.124.57.32.764l.77.756 4.793-4.745c.262-.259.422-.619.422-1.015v-7.2c0-.792-.654-1.44-1.454-1.44Zm0 8.64-3.157 3.125.975-3.845H3.955V9.28l2.181-5.04h6.546v7.2ZM15.59 2.8H18.5v8.64h-2.91V2.8Z"></path></svg>                                      </button>
                                    </a-tooltip>
                                </div>
                                  <div class="text-gray-400 flex self-end lg:self-center justify-center mt-2 gap-3 md:gap-4 lg:gap-1 lg:absolute lg:right-0 lg:mt-0 lg:pl-2 visible">
                                    GPT-3.5
                                    <a-tooltip placement="top" title="Copy" :color="tooltipColor">
                                      <button @click="copyChatDialogue($event, 'ai')" class="p-1 rounded-md hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-200 disabled:dark:hover:text-gray-400">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="none" aria-label="Copy" viewBox="0 0 12 12" class="cursor-pointer text-th-primary-light hover:text-th-primary-dark"><g clip-path="url(#copy_svg__a)"><path fill="currentColor" d="M7.41 1h-5c-.5 0-.91.41-.91.91v5.908a.456.456 0 0 0 .91 0V2.364c0-.25.204-.455.454-.455h4.545c.25 0 .455-.204.455-.454A.456.456 0 0 0 7.409 1Zm1.817 1.818h-5c-.5 0-.909.41-.909.91v6.363c0 .5.41.909.91.909h5c.5 0 .908-.41.908-.91V3.728c0-.5-.409-.909-.909-.909Zm-.454 7.273H4.682a.456.456 0 0 1-.455-.455V4.182c0-.25.205-.455.455-.455h4.09c.25 0 .455.205.455.455v5.454c0 .25-.204.455-.454.455Z"></path></g><defs><clipPath id="copy_svg__a"><path fill="#fff" d="M0 0h12v12H0z"></path></clipPath></defs></svg>
                                      </button>
                                    </a-tooltip>
                                    <a-tooltip placement="top" title="Delete" :color="tooltipColor">
                    ...
                    <div v-if="conversation.length == 0"
                      ...
                      <h1  :style=" theme === 'light'?'color:#000!important;':'color:#858699!important;'"
            ...
            <div
                ...
                <div class="relative flex h-full flex-1 md:flex-col">
                  <div class="flex ml-1 md:w-full md:m-auto md:mb-2 gap-0 md:gap-2 justify-center">
                    <button v-if="!convLoading && conversation.length > 0" @click.stop.prevent="chatRepeat"
                      ...
                      <span class="none">Regenerate response</span>
                    </button>
                    ...
                    <button v-if="convLoading" @click.stop.prevent="stopChat" id="stopChat"
                      ...
                      <div v-show="isShowGoTop" @click="handleScrollTop" style="height: 34px;width: 34px;margin-top:5px;position: fixed; right: 20px;">
                        <a-button :class=" theme === 'light'?'lightButtonBackground':'darkButtonBackground'" style="max-height: 34px; min-width: 34px; max-width: 34px; padding: 0px;display: flex; justify-content: center; align-items: center;">
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" class="transform rotate-180"><g clip-path="url(#arrow_drop_down_svg__a)"><path fill="currentColor" d="m4.33 7.239 2.886 2.885a1.11 1.11 0 0 0 1.57 0l2.886-2.885c.702-.702.201-1.905-.79-1.905H5.11c-.991 0-1.482 1.203-.78 1.905Z"></path></g><defs><clipPath id="arrow_drop_down_svg__a"><path fill="#fff" d="M0 0h16v16H0z"></path></clipPath></defs></svg>                        </a-button>
                      </div>
                  </div>
                  <div
                    ...
                    <textarea v-model="chatMsg" ref="inputChat" @keydown="judgeInput" tabindex="0" data-id="root"
                              style="max-height: 200px; height: 24px; overflow-y: hidden;" rows="1" :placeholder="'Message ' + sourceInfoMessage"
              ...
              <div class="px-3 pt-2 pb-3 text-center text-xs text-black/50 dark:text-white/50 md:px-4 md:pt-3 md:pb-6">
                <!--                <a href="https://gitee.com/MIEAPP/chatai-vue" target="_blank" rel="noreferrer" class="underline">开源：chatai-vue</a> 本开源项目前端使用vue，后端基于openai开放api开发，仅供学习 AI 使用。-->
              </div>
            </div>
          </main>
        </div>
        ...
        <!-- 菜单导航 -->
        <div class="dark hidden bg-gray-900 md:fixed md:inset-y-0 md:flex md:w-[260px] md:flex-col menuCont" style="border-right: #2c2d3c 1px solid;">
            ...
            <div ref="menu" class="scrollbar-trigger flex h-full w-full flex-1 items-start border-white/20">
              ...
              <nav ref="navEle" class="flex h-full flex-1 flex-col space-y-1 p-2">
                <a @click.stop="newChat"
                   class="flex py-3 px-3 items-center gap-3 rounded-md hover:bg-gray-500/10
                    transition-colors
                     duration-200
                     text-white
                     cursor-pointer
                     text-sm mb-2 flex-shrink-0 border border-white/20">
                  <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round"
    ...
    <div v-show="false" class="semi-portal" style="z-index: 1000;">
      <div class="">
            ...
            <div class="fixed inset-0 z-50 overflow-y-auto">
              <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                ...
                <div v-if="false"
                  ...
                  <form>
                    <textarea id="feedback-other" placeholder="What would the ideal answer have been?" rows="3"
                              class="mt-4 mb-1 w-full rounded-md dark:bg-gray-800 dark:focus:border-white dark:focus:ring-white"
                              tabindex="0" style="height: 89.4815px; overflow-y: hidden;"></textarea>
                  </form>
...
import ToggleSource from "./components/toggleSource.vue";
...
export default {
  components:{ToggleSource},
  data() {
    return {
      sourceInfoMessage:"GPT-3.5",
      tooltipColor:"#fff",
      theme: "light",
      popupShow: true,
      avatarIdx: 1,
  ...
  methods: {
    ...
    copyChatDialogue(event,type){
      debugger;
      const target = event.currentTarget;
      let code =  null;
      if(type === 'oneself'){
        code = target.parentNode.parentNode.parentNode.parentNode.firstChild.innerText;
      }else{
        code = target.parentNode.parentNode.parentNode.firstChild.innerText;
      }
      console.log(code);
      this.$copyText(code).then(
        () => {
    ...
    send() {
      ...
      var that = this;
      var source = this.source = new EventSource(`https://devapi.flares.ai/api/v1/chat/${this.cid}?prompt=${encodeURIComponent(chatMsg)}`);
    ...
    generateConvTitle(conv) {
      var that = this;
      var tsource = this.tsource = new EventSource(`https://devapi.flares.ai/api/v1/chat/title/${this.cid}`);
    ...
    loadId() {
      var that = this;
      this.axios.post(`https://devapi.flares.ai/api/v1/generate/id`, {})
          .then((result) => {
            console.log(result);
            that.cid = result.data.data;
            this.conversation = []
          })
          .catch((err) => {
          });
    ...
    selectConversation(conv, loadConv) {
      ...
      this.axios.get(`https://devapi.flares.ai/api/v1/conv/${conv.id}`)
          .then((result) => {
            console.log(result);
    ...
    isScrollAndNotTop() {
      ...
      if (!chatDivEle) {
        ...
        // chatDivEle.scrollHeight:1360
        // chatDivEle.clientHeight:653
      if (chatDivEle.scrollHeight <= chatDivEle.clientHeight) {
        this.isShowGoTop = false;
        return;
      }
      // scrollTop:222.96298217773438
      // windowHeight:653
      // scrollHeight:1360
      const scrollTop = chatDivEle.scrollTop;
      // const windowHeight = chatDivEle.clientHeight;
...
.darkButtonBackground{
  ...
  border: #292a35 1px solid!important;
  color:#858699!important;
}
.darkButtonBackground:hover{
